...
public class CoffeeOrder {
	...
	// 價格對照表
	// final速度快,資料固定在那個位置,static是為了讓全部都可以用到
	private static final Map<String, Map<String, Integer>> priceTable = Map.of("latte",
			Map.of("S", 50, "M", 70, "L", 90), "mocha", Map.of("S", 45, "M", 55, "L", 65), "americano",
			Map.of("S", 40, "M", 45, "L", 60), "cappuccino", Map.of("S", 55, "M", 80, "L", 100));
